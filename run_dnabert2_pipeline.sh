...
echo "=== STEP 0: check required packages ==="
python - <<'PY'
...
echo "=== STEP 1: build train/test dataset ==="
python ~/microbiome_taxonomy/build_dnabert2_read_dataset_split.py

echo "=== STEP 2: train DNABERT2 classifier ==="
...
echo "=== DONE ==="
echo "Train CSV:  ~/scratch/dnabert2_reads_10samples.train.csv"
echo "Test CSV:   ~/scratch/dnabert2_reads_10samples.test.csv"
echo "Model dir:  ~/scratch/dnabert2_read_model_10samples"
